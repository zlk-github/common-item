package com.hpq.item.service.impl;
...
import com.hpq.item.mapper.UserMapper;
import com.hpq.item.service.IUserService;
import com.hpq.item.util.BeanExUtils;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public PageBean<UserVO> pageList(UserParam userParam) {
        ...
        Page<User> userPage = new Page<>(userParam.getPageNo() , userParam.getPageSize());
